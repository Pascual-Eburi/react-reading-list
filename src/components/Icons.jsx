export function ThemeLightIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="icon" viewBox="0 0 24 24" id="moon">
...
export function RemoveFromReadingListIcon(){
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" id="remove">
